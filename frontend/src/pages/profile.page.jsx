...
const ProfilePage = () => {
    ...
    const getBlogs = ({page=1, user_id}) =>{
        user_id = user_id === undefined ? blogs?.user_id : user_id;   // ✅ optional chaining
    ...
    return (
        <AnimationWrapper>
        {
            ...
            <section className='h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12'>
                <div className='flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-1 border-grey md:sticky md:top-[100px] md:p-10'>
